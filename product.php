...
<form action="cart.php?prodcut_id=<?php $row['product_id']?>" method="post" class="product-card" enctype="multipart/form-data">
				...
				<div class="row">
					...
					<div class="col-md-5 col-md-push-2">
						<div id="product-main-img" class="slick-initialized slick-slider"><button class="slick-prev slick-arrow" aria-label="Previous" type="button" style="display: block;">Previous</button>
							...
							<img src="data:image/jpeg;base64,<?=base64_encode($row["products_img"])?>" style="height: 270px; width: 70%;" alt="tech">
					...
					<div class="col-md-5">
						...
						<h5 class="product-name" style="text-align:left"> <?=$row['products_name']?></h5>
							...
							<div class="add-to-cart">
								...
								<input type="submit" class="add-to-cart-btn" name="add-to-cart-btn"></button>
							</div>
